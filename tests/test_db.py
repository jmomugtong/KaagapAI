...
# Mock Database URL (should use a test DB in real implementation, but for now we assume connection to the main one or a test container)
# In CI/CD, this would point to a service.
TEST_DATABASE_URL = "postgresql+asyncpg://medquery_user:medquery_password@localhost:5432/medquery"
...
async def engine():
    ...
    async with engine.begin() as conn:
        ...
        await conn.execute(text("DROP TABLE IF EXISTS user_feedback, queries_log, embeddings_cache, clinical_docs, users, hospitals CASCADE"))
